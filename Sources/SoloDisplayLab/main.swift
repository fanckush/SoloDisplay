...
solodisplay-lab replay <trace.json>
    Replay a normalized controller trace without changing displays.

solodisplay-lab example-trace
    Print a sanitized synthetic trace for replay experiments. Does not access displays.

solodisplay-lab probe --external <id> --scope app|session --journal <new-path> --native-wired-attested [--ending restore|exit|handoff]
...
solodisplay-lab restore --journal <path>
